...
> El empaquetado en imagen Docker y los binarios de release cross-platform están planificados
> pero **aún no disponibles**; por ahora se compila desde el código. Ver
