...
> **Estado:** Fase 3 (modelos y converters) completada. El payload generado en Go es byte a byte
> compatible con el original para 1 335 casos de corpus (21 descartados con prueba de defecto en
> grabador). Frontera 1 de D1 cerrada. Próxima fase: transporte (Fase 4). Ver
> `docs/superpowers/plans/` para más detalles del port.
